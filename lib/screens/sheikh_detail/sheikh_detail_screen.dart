...
/// Full, paginated list of one sheikh's lectures. Pagination is managed locally
/// in State (cursor + scroll listener) rather than via a Riverpod family
/// notifier — simpler and avoids the family-AsyncNotifier rough edges.
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, i) {
        ...
        return LectureListTile(
          lecture: lecture,
          showSheikh: false, // redundant on a single-sheikh screen
